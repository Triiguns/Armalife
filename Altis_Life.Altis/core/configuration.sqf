...
//[shortVar,reward]
life_illegal_items = [["heroinu",1200],["heroinp",3500],["cocaine",1500],["cocainep",4500],["marijuana",2500],["turtle",3500],["blastingcharge",10000],["boltcutter",500],["kidney",5000]];
...
[
	...
	["storagesmall",75000],
	["storagebig",150000],
    ["kidney",5000] //Oubliez pas les Virgules si c'est le dernier
];
