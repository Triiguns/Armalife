...
switch (_vehicle) do
{
	...
	case "C_Hatchback_01_sport_F":
	{
		switch(_index) do
		{
			...
			case 5: {_color = "Green"};
			case 6: {_color = "Cop"};
			case 7: {_color = "Vehicule de Police Rapide"};
		};
	};
	...
	case "C_SUV_01_F":
	{
		switch (_index) do
		{
			...
			case 4: {_color = "Cop";};
			case 5: {_color = "SUV Police";};
			case 6: {_color = "SUV BMW";};
			case 7: {_color = "SUV ferrari";};
			case 8; {_color = "SUV Medic";};
		};
	};
