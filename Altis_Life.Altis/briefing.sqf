...
player createDiarySubject ["changelog","Evolution serveur "];
player createDiarySubject ["serverrules","Regelement Général"];
player createDiarySubject ["policerules","Procédure de Police"];
player createDiarySubject ["controls","Amende"];
player createDiarySubject ["safezones","Safe Zones (No Killing)"];
player createDiarySubject ["civrules","Reglememnt Civil"];
player createDiarySubject ["legalitems","Activité Légal"];
player createDiarySubject ["illegalitems","Activité Illégal"];
player createDiarySubject ["gangrules","Reglement des Gangs"];
player createDiarySubject ["terrorrules","Reglement des Rebelle"];
